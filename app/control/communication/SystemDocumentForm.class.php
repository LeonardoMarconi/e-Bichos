...
class SystemDocumentForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $biological_sample_id = new TDBCombo('biological_sample_id', 'communication', 'BiologicalSample', 'id', 'Nº 00{id}/UTM:{utm}/{location}');
        ...
        $this->form->addFields( [$lc=new TLabel(('Refere-se a Amostra Biológica'))], [$biological_sample_id] );
        ...
        $biological_sample_id->setSize('60%');
        ...
        $biological_sample_id->addValidation( _t('Biological Sample'), new TRequiredValidator );
