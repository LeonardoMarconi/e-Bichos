<?php
/**
 * RoutesFormList Form List
 * @author  <your name here>
 */
class RoutesFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_Routes');
        $this->form->setFormTitle('Rotas [Cadastro]');
        ...
        $route->addValidation('Rota', new TRequiredValidator);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Routes
            $repository = new TRepository('Routes');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new Routes($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Routes;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('communication'); // open a transaction
                $object = new Routes($key); // instantiates the Active Record
